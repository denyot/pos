...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	String WERKS = (String)request.getParameter("WERKS");
	...
	<head>
		<meta charset="utf-8">
			<base href="<%=basePath%>">
				...
				<script src="longhaul/pos/report/js/sallingInfo.js"></script>
				<link rel="stylesheet"
...
.ui-autocomplete-loading {
  ...
  <table border="0" id="orderheadlist" width="100%">
   ...
   <tr  class="1000show" style="display: none;">
   	<td>区域：</td>
   	<td><select id="zone"></select></td>
   	<td>门店：</td>
   	<td><select id="werks"></select></td>
    ...
    <td colspan="8" >
	 ...
	 <thead>
		<tr>
			...
			<th style="display: none;" class="1000show">区域</th>
			<th style="display: none;" class="1000show">专柜</th>
			<th>品类名称</th>
			<th>销售总件数</th>
			<th>销售总金额</th>
		</tr>
  ...
  <div id="dialog" title="helloworld" style="display: none;"> 
  	<iframe name="showdetail">
