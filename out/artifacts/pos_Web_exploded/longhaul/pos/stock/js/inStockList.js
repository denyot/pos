...
Ext.onReady(function() {
	...
	var store = new Ext.data.Store({
		...
		proxy : new Ext.data.HttpProxy({
			url : 'stockSystem.ered?reqCode=getHaveInStockHeader'
		}),
		// 数据读取器
...
//		}
	...
	function getTotal() {
		...
		Ext.getCmp("totalweight1").setText(Number(totalweight1).toFixed(3));
	...
	function getCount() {
		...
		Ext.getCmp("totalweight2").setText(Number(totalweight2).toFixed(3));
	}
