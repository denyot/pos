...
<html>
  <head>
    ...
    <script src="resource/jquery/jquery.alerts-1.1/jquery.alerts.js" type="text/javascript"></script>
	<script src="resource/jquery/jquery.multiSelect-1.2.3/jquery.multiSelect.js" type="text/javascript"></script>
	
	<!-- <script src="resource/wdTree/wdTree/src/Plugins/jquery.tree.js" type="text/javascript"></script>
	<script src="resource/wdTree/wdTree/data/tree1.js" type="text/javascript"></script> -->
	...
	<!-- <link href="resource/wdTree/wdTree/css/tree.css" rel="stylesheet" type="text/css" /> -->
	
	<script src="longhaul/pos/choiceorder/js/choiceorderforheadquarters.js" type="text/javascript"></script>
	<script src="longhaul/pos/stock/js/orderdate.js" type="text/javascript"></script>
	<link href="resource/jquery/jquery.alerts-1.1/jquery.alerts.css" rel="stylesheet" type="text/css" />
  ...
  <body style="width :100%">
	...
	<table  id="ordersystemtable"  width="100%" border="0">  
			...
			<tr id="goldRow" style="display: none;">
				...
				<td>
					...
					<span id="lessToneSpan">
						...
						<select id="werksInfo" multiple="multiple" size="8" style="width:180px;height:200px;display: none;">
						</select>
			...
			<tr>
				<td>
					货品尺寸：
					<input name="goodsize" id="goodsize" class="inputnumbernom"/>
				...
				<td>
					...
					<span id="toneFireColorSpan" style="display: none">
						...
						<select id="style">
							<option value=''>请选择...</option>
							<%--<option value='风格1'>风格1</option>
							<option value='风格2'>风格2</option>
						--%></select>
					
					系列：
						<select id="series">
							<option value=''>请选择...</option>
							<%--<option value='1系列'>1系列</option>
							<option value='2系列'>2系列</option>
						--%></select>
					...
					工&nbsp;&nbsp;&nbsp;&nbsp;艺：
					 ...
					 <select id="mytechnics" name="technics" multiple="multiple" size="8" style="width:80px;height:70px;display:none;">
					 </select>
					 
					 </span>
					 货品名称:
					<input name="zhlhx"  id="zhlhx" style="width:130px" readonly="readonly">
				</td>
			</tr>
			<tr>
				...
				<td width="100%" colspan="3" id="tdtablecontent" align="center">
					<table border="0" id="tablecontent" width="100%">
						...
						<thead>
							...
							<tr>
							    <td class="tdtotallevel" colspan="8 " style="font-size: 20px; font-weight: bold;" align="center">
							        总计    
							    </td>
								...
								<td class="tdtotallevel" id="tdLast" colspan="3">
									&nbsp;    
								</td>
							</tr>
	...
	<!-- 		<div id="statementaccount" title="">
		...
		<div id="tree" style="width:150px;height: 100px; overflow: auto; display:none;"></div>
