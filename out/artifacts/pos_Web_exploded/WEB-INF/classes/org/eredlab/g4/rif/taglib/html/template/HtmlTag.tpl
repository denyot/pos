<!--
此页面代码由LH-AIG SAP系统集成与应用开发平台模板引擎组件强力驱动生成
     copyRight(c) 2007-2011, 深圳论衡信息(longhaul).
                  www.longhaul.com.cn
-->
<!-- 您请求的URL为:$requestURL -->
...
<head>
<title>${title}</title>
<meta http-equiv="keywords" content="LH-AIG,longhaul,ExtJS,Demo,在线演示,SAP系统集成与应用开发平台,深圳论衡信息">
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<meta http-equiv="description" content="It's Based LH-AIG！copyRight(c) longhaul">
...
<script type="text/javascript" src="${contextPath}/resource/ext-3.4.0/adapter/ext/ext-base.js"></script>
  #if(${extMode} == "debug")
<script type="text/javascript" src="${contextPath}/resource/ext-3.4.0/ext-all-debug.js"></script>
  #else
<script type="text/javascript" src="${contextPath}/resource/ext-3.4.0/ext-all.js"></script>
  #end
...
#if(${uxEnabled} == "true")
<script type="text/javascript" src="${contextPath}/resource/ext-3.4.0/ux/ux-all.js"></script>
<link rel="stylesheet" type="text/css" href="${contextPath}/resource/ext-3.4.0/ux/css/ux-all.css"/>
#end
#if(${fcfEnabled} == "true")
