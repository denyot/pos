...
public class FTPFileList
{
  ...
  public static FTPFileList create(InputStream stream, FTPFileEntryParser parser, String encoding)
    throws IOException
  {
  ...
  public void readStream(InputStream stream, String encoding)
    throws IOException
  {
