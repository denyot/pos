...
import org.eredlab.g4.ccl.net.telnet.EchoOptionHandler;
import org.eredlab.g4.ccl.net.telnet.InvalidTelnetOptionException;
import org.eredlab.g4.ccl.net.telnet.SimpleOptionHandler;
import org.eredlab.g4.ccl.net.telnet.SuppressGAOptionHandler;
import org.eredlab.g4.ccl.net.telnet.TelnetClient;
import org.eredlab.g4.ccl.net.telnet.TelnetNotificationHandler;
import org.eredlab.g4.ccl.net.telnet.TerminalTypeOptionHandler;
							...
							if (new String(buff, 0, ret_read).startsWith("AYT")) {
								...
								try {
									...
									int opcode = new Integer(st.nextToken())
											.intValue();
									boolean initlocal = new Boolean(st
											.nextToken()).booleanValue();
									boolean initremote = new Boolean(st
											.nextToken()).booleanValue();
									boolean acceptlocal = new Boolean(st
											.nextToken()).booleanValue();
									boolean acceptremote = new Boolean(st
											.nextToken()).booleanValue();
								...
								try {
									...
									System.err
											.println("Error registering the spy");
								}
							} else if (new String(buff, 0, ret_read)
									.startsWith("UNSPY")) {
								tc.stopSpyStream();
