...
public final class TimeUDPClient extends DatagramSocketClient
{
    ...
    throws IOException
  {
    ...
    long time = 0L;
    time |= (this.__timeData[0] & 0xFF) << 24 & 0xFFFFFFFF;
    time |= (this.__timeData[1] & 0xFF) << 16 & 0xFFFFFFFF;
    time |= (this.__timeData[2] & 0xFF) << 8 & 0xFFFFFFFF;
    time |= this.__timeData[3] & 0xFF & 0xFFFFFFFF;
